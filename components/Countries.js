...
export default function Countries() {
  ...
  return (
    <div className="flex flex-col  pt-3 px-5 lg:px-0 relative">
      <div className="w-full mb-6">
        <div className="relative" ref={dropdownRef}>
          {/* Dropdown button */}
          <button
            onClick={toggleDropdown}
            className="w-full lg:w-auto bg-[#e6e8f1] border-2 border-[#B0B6D3] text-[#5462A0] px-4 py-3 lg:px-20 lg:py-5 font-semibold rounded-md flex items-center justify-between"
          >
