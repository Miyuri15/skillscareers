...
export default function JobFindBanner() {
  return (
    <>
      <div className="flex pt-5 px-20 ml-5 relative">
        {/* Search content section */}
        <div className="w-2/3  pt-20 relative overflow-hidden ">
          ...
          <div className="flex flex-wrap justify-between items-center gap-4 mb-8 ml-1 w-auto rounded-md">
            <select className="bg-[#e6e8f1]  border-2 border-[#B0B6D3] text-[#5462A0] px-20 py-5 font-semibold rounded-md">
          ...
          <div>
            ...
            <div className="flex items-center">
              ...
              {/* Active user stats */}
              <div className="min-h-20 text-blue-900 font-bold m-3 mt-20">|</div>
              <div>
            ...
            {/* Features section */}
            <div className="flex mb-10 mt-20 space-x-20 text-blue-700 ">
