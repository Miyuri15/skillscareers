    ...
    <>
      <div className="flex flex-col p-6 bg-white min-h-screen rounded-xl">
        <div className="p-3 flex flex-grow justify-between items-center">
          <p className="text-[#001571] text-xl font-bold">Application</p>
        ...
        <div>
          ...
          <div className="p-4 sm:p-10 text-left mt-20">
            {candidates.map((candidate) => (
              <div key={candidate.id}>
                ...
                <p className="text-gray-800 mt-4 sm:mt-8 font-sans">
          ...
          {/* Experience Section */}
          <div className="bg-white px-10 pt-3 rounded-lg  font-sans ">
            <div className="flex flex-grow justify-between">
