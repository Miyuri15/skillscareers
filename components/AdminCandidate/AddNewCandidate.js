...
export default function AddNewCandidate({ onClose }) {
  const [formData, setFormData] = useState({
    candidateName: "",
    email: "",
    phone: "",
    package: "Basic Candidate Package", // Default value
    password: "",
    confirmPassword: "",
  });
  ...
  const handleSubmit = (e) => {
    ...
    // Example validation
    if (!formData.candidateName || !formData.email || !formData.phone) {
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <select
              ...
              className="mt-1 block w-full border border-[#B0B6D3] rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm px-3 py-2"
            >
              <option value="Basic Candidate Package">Basic Candidate Package</option>
              <option value="Advanced Candidate Package">Advanced Candidate Package</option>
              <option value="Premium Candidate Package">Premium Candidate Package</option>
            </select>
          </div>
          <div>
            <label className="block text-sm font-semibold text-[#001571]">
