...
export default function Categories() {
  ...
  // Shuffle categories 
  useEffect(() => {
    setCategories((prev) => [...prev].sort(() => Math.random() - 0.5));
  }, []);
        ...
        <div className="relative min-h-screen flex flex-col">
          ...
          <div className="absolute top-0 left-0 w-full p-4 sm:p-6 md:p-10">
            <div className="mt-10 mb-12">
              <h2 className="text-3xl sm:text-4xl text-[#8A93BE] font-bold font-sans">
                Search for Job<span className="text-[#001571]"> Categories</span>
              </h2>
            ...
            <div className="bg-[#E6E8F1] h-auto mb-12 rounded-md">
              <div className="flex flex-wrap justify-between items-center gap-4">
                <input
                  ...
                  className="bg-[#E6E8F1] flex-grow px-6 py-6 focus:outline-none w-full sm:w-[60%] md:w-[45%] lg:w-[30%] rounded-md font-semibold placeholder-[#5462A0]"
                />
                <button className="bg-[#001571] text-white px-4 py-3 mr-2 rounded-md font-semibold w-full sm:w-auto">
